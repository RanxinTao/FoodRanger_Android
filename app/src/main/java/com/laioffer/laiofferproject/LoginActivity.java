...
public class LoginActivity extends AppCompatActivity {
     ...
     * a. Define URL, get username and password from textviews
     * b. Send login request to specified URL and get response in onResponse()
     * c. Parse Json string format from backend service and start another activity
     * d. Save cookies to Config.java
     */
    public void LoginAuthentification() {
        ...
        String url = "http://laiproject.mooo.com/chihuo/LoginServlet?user_id=" +
                ...
                try {
                    ...
                    if (result.equals("OK")) {
                        ...
                        Toast.makeText(getBaseContext(),
                                "Please reenter your account and password",
